...
#define WEB_URL "https://api.newayz.com/location/hub/v1/track_points?access_key=mrlNB0rxjeoCHFvA5owaobo5eoevOXXN"
...
static void cJsonTask(void *pvParameters)
{
 /* declare a few. */
    ...
    while (1)
    {
        ...
        if (0 == realTime)
        {
            cJSON_AddNumberToObject(root, "timestamp", 1603266263280);
        }
        else
        {
            cJSON_AddNumberToObject(root, "timestamp", realTime);
        }
